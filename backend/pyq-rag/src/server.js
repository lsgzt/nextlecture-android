...
app.get('/health', (_req, res) => res.json({ ok: true, service: 'gndec-pyq-rag-api', version: '1.0.0', dependencies: { supabase: hasSupabase(), gemini: hasGemini(), geminiKeysConfigured: config.geminiApiKeys.length } }));
